...
<p>Als er iets is waar je over wilt praten, of als je andere plannen of ideeën hebt, dan kan je naar dit adres emailen:  <a href="mailto:support@tweekly.fm">support@tweekly.fm</a>.</p>
        ...
        <div class="row" style="color: #747474 !important;">
          <div class="col-sm-6">
            <h3><i class="fa fa-tumblr"></i> Wat moeten we doen?</h3>
            <p>Als je 30 seconden over hebt, graag <a href="http://q.tweekly.fm/take_survey.php?x=NTQzMjI%3D&utm_source=help-fundraiser&utm_medium=website&utm_campaign=help.tweekly.fm">klikken</a>.</p>
            <p>De antwoorden van deze enquête zullen gebruikt worden om de toekomst van tweekly.fm te bepalen.</p>
          </div>

          <div class="col-sm-6">
            <h3><i class="fa fa-user"></i> Bedankt</h3>
			<p>Ik wil graag de volgende mensen bedanken voor hun hulp met de vertalingen::<br /></p>
			<ul>
        ...
        <div class="row" style="color: #747474 !important;">
          <div class="col-sm-3">
            <h3><i class="fa fa-credit-card"></i> Doneer via Paypal (USD)</h3>
			<div style="text-align: center">
				...
				<p><small>Je mag ook direct doneren aan support@tweekly.fm</small></p>
			</div>
          </div>

          <div class="col-sm-3">
            <h3><i class="fa fa-credit-card"></i> Doneer via Paypal (GBP)</h3>
			<div style="text-align: center">
          ...
          <div class="col-sm-3">
            <h3><i class="fa fa-bitcoin"></i> Doneer Bitcoin</h3>
			<div style="text-align: center">
          ...
          <div class="col-sm-3">
            <h3><i class="fa fa-money"></i> Doneer Litecoin</h3>
			<div style="text-align: center">
				<script src="http://coinwidget.com/widget/coin.js"></script>
				<script>
				CoinWidgetCom.go({
      ...
      <div class="footer">
        <div class="row" style="color: #747474 !important;">
          <div class="col-sm-8">
          	<h3>Bedankt voor het lezen.</h3>
            <p>
				Dit is een persoonlijk dankbericht voor het lezen van deze pagina. Zelfs als je de pagina verlaat en het project verder niet helpt, waardeer ik het toch dat je de tijd en moeite nam om dit bericht te lezen. Voor mij bewijst dat dat tweekly.fm een positieve invloed op jouw leven had.
            </p>
